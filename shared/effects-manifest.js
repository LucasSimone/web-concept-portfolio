...
(function (global) {
  global.EFFECTS_MANIFEST = [
    ...
    {
      slug: 'type-pan-vertical',
      name: 'Type Pan Vertical',
      category: 'text-effects',
      demoPath: '/text-effects/type-pan-vertical/index.html',
      jsPath: '/text-effects/type-pan-vertical/type-pan-vertical.js',
      docsPath: '/docs/text-effects/type-pan-vertical.html',
    },
    {
      slug: 'type-pan-horizontal',
      name: 'Type Pan Horizontal',
      category: 'text-effects',
      demoPath: '/text-effects/type-pan-horizontal/index.html',
      jsPath: '/text-effects/type-pan-horizontal/type-pan-horizontal.js',
      docsPath: '/docs/text-effects/type-pan-horizontal.html',
    },
    {
      slug: 'rolodex',
      name: 'Rolodex',
