 ...
 *
 * Usage: give any element `class="bg-circuit-board"` (it needs `position:
 * relative` — see the CSS block shipped alongside this file) and call
 * `CircuitBoard.initAll()`, or `new CircuitBoard(el)` for a single element.
 */
(function (global) {
  const DEFAULTS = {
    cell: 34,
